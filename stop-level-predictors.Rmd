...
# Filtering Data Outside the Seattle Bounding Box (see route-level-predictors)
route_predictors <- read_csv("predictor_tables/route_predictors")
...
# Setting up final predictor table
```{r}
stop_predictors <- gtfs_main_withcongestion %>%
  select(route_id, stop_id, arrival_delay, stop_sequence, shape_dist_traveled, weekday, hr, avg_traffic_dayhour)
```
...
# MOVEMO EMVMOVEMOVEMVMEO assorted Visualizations
