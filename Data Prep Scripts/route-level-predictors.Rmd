...
# Set up dataframe to hold route_id + predictors
...
# For each route_id, overlay on spatial traffic and compute weighted average
...
## Cutting routes to the bounding box of what I have
```{r}

```

# Traffic Spatial Function
```{r}
...
# For each route_id, draw a buffer and compute weighted average for ACS Ridership %
```{r}
